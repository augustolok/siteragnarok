...
*/ function hidecadastro(){	 	 $('#new_div').hide(); }

function LINK_ajax(http, div_name) { //fun��o para links
...
function POST_ajax(http, div_name, frm_name) { //fun��o para posts
...
function GET_ajax(http, div_name, frm_name) { //fun��o para gets
