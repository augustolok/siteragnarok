...
if ($quantos)
	echo "<tr><td a><b><span title=\"See who is online\" style=\"cursor:pointer\" onMouseOver=\"this.style.color='#FF3300'\" onMouseOut=\"this.style.color='#000000'\" onClick=\"LINK_ajax('whoisonline.php','main_div');\">".$lang['SERVERSTATUS_USERSONLINE']."&nbsp;</span></b></td><td align=\"right\">$quantos</td></tr>";
else
	echo "<tr><td ><b>".$lang['SERVERSTATUS_USERSONLINE']."&nbsp;</b></td><td align=\"center\">$quantos</td></tr>";
