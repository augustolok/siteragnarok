					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li class="current"><a href="info.php">Informação</a></li>
							...
							<div class="col-8 col-12-medium imp-medium">
								...
								<!-- Content -->
									<article class="box post">
										<!----> Content<a href="#" class="image featured"><img src="images/info.jpg"  /></a> 
										<header>
											<h2> Informações <img src="/images/anubis.gif" alt="" sizes="15" width="70" srcset=""></h2>
										</header>
										<p><table id="tablePreview" class="table">
											<!--Table head-->
											<thead>
												<tr>
												<th></th>
											...
											<tbody>
												...
												<tr>
												<th scope="row">Rates Quest</th>
												<td>9x</td>
												</tr>
												<tr>
												<th scope="row">EXP extra por membro no grupo</th>
												<td>5%</td>
												</tr>
												<tr>
												<th scope="row">rate card</th>
												<td>0.06%</td>
												
												</tr>
												<tr>
												<th scope="row">rate MVP card</th>
												<td>0.01%</td>
												</tr>
											</tbody>
											<!--Table body-->
											...
											<tbody>
												<tr>
												<th scope="row">@go</th>
												<td>teleporta para cidades de uma lista.</td>
												
												</tr>
												<tr>
													<th scope="row">@rates</th>
													<td>Consulta atual rate do serve.</td>
												</tr>
												<tr>
													<th scope="row">Lista de NPC</th>
													<td></td>
												</tr>
												<tr>
													<th scope="row">Corrida poring</th>
													<td>Devil squard</td>
												</tr>
												<tr>
													<th scope="row">MVP point</th>
													<td>Presenca e muito mais...</td>
												</tr>
