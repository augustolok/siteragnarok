...
a mail to rlcpr1f7_ragnarok@gmail.com
*/

//sql connections
$CONFIG['rag_serv']		=	'localhost';	// SQL Ragnarok Host
$CONFIG['rag_user']		=	'login';		// SQL Ragnarok User
$CONFIG['rag_pass']		=	'senha';		// SQL Ragnarok Password
...
$CONFIG['cp_user']		=	'login';		// SQL CP User
$CONFIG['cp_pass']		=	'senha';		// SQL CP Password
...
//Admin Area
$CONFIG['cp_admin']		=	'0';			// CP admin functions
$CONFIG['gm_level']		=	'0';			// CP GM funtions
$CONFIG['gm_hide']		=	'0';			// GMs this level and above will be hidden from whoisonline.php
...
//server name, rates
$CONFIG['name']			=	'Ragnarok';	// name of the server
$CONFIG['rate']			=	'1x/1x/1x';		// rates of the server
...
$CONFIG['dynamic_name']		=	'Ragnarok';	// The name of the server in ragsrvinfo's server name column (Used for dynamic info)
$CONFIG['show_rates']		=	'0';			// Show rates below server status?

//map,char,login servers settings
$CONFIG['accip']			=	'167.114.189.192';	// Account/Login Server IP
$CONFIG['accport']		=	'8919';		// Account/Login Server Port
$CONFIG['charip']			=	'167.114.189.192';	// Char Server IP
$CONFIG['charport']		=	'2792';		// Char Server Port
$CONFIG['mapip']			=	'167.114.189.192';	// Zone/Map Server IP
$CONFIG['mapport']		=	'5117';		// Zone/Map Server Port
